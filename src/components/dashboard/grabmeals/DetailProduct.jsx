...
const DetailProduct = () => {
  ...
  const handleAddToCart = () => {
    ...
    if (quantity > product.stok) {
      ...
      if (messageElement) {
        messageElement.textContent = "Jumlah melebihi stok yang tersedia";
    ...
    try {
      ...
      if (existingItemIndex !== -1) {
        ...
        if (newQuantity > product.stok) {
          const messageElement = document.getElementById('success-message');
          if (messageElement) {
            messageElement.textContent = "Total quantity in cart exceeds available stock";
            messageElement.classList.remove('hidden', 'text-green-600');
            messageElement.classList.add('text-red-600');
            messageElement.classList.remove('hidden');
      ...
      const messageElement = document.getElementById('success-message');
      if (messageElement) {
        messageElement.textContent = "Berhasil ditambahkan ke keranjang";
          ...
          <section className="min-h-screen mx-10">
            <div className="flex mt-5 gap-5 justify-between">
              ...
              <div className="flex-1 max-h-64 rounded-xl p-5 bg-white shadow-md flex flex-col">
                  ...
                  <div className="flex items-center border rounded-lg py-1 px-3">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 1) {  // Cek hanya untuk nilai minimal 1
                          setQuantity(value);
                        }
                      }}
                      className="text-green-600 text-xl font-bold mx-4 w-12 text-center focus:outline-none"
                    />
                ...
                <p className="m-3 text-gray-500 text-sm">Sisa stok: {product.stok}</p>
                {/* Total */}
                ...
                <h2
                  id="success-message"
                  className="hidden text-green-600 text-xs font-semibold pt-2 mt-5"
                >
